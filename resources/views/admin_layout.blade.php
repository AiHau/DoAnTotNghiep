...
<head>
    ...
    <meta name="keywords" content="Visitors Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
     Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
...
<body>
    <section id="container">
      ...
      @impersonate
      <li class="sub-menu">
                <span><a href="{{URL::to('/impersonate-destroy')}}"> Stop change role</a></span>
            </a>
...
<section id="main-content">
    ...
    <div class="footer">
       <div class="wthree-copyright">
         <p>Trang quản trị website bán laptop online của Ái Hậu</p>
     </div>
 </div>
 <!-- / footer -->
</section>

                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="logo pull-left">
                                <a href="index.html"><img src="{{asset('public/frontend/images/advanced.png')}}" width="170" height="70" alt="" /></a>
                            </div>
                            <div class="btn-group pull-right">
                                ...
                                <form action="{{URL::to('/tim-kiem')}}" method="POST">
                                    ...
                                    <div class="search_box pull-right">
                                        ...
                                        <span type="submit" id="sear-suce"  name="search_items" class="btn btn-primary btn-sm"><i class="fa fa-search"></i></span>
                                    </div>
                                </form>
                        ...
                        <div class="col-sm-7">
                            <div class="shop-menu pull-right">
                                ...
                                if($customer_id!=NULL){ 
                                   ...
                                   ?>
                                   <li><span class="sign-in" ><a href="{{URL::to('/dang-nhap')}}">Đăng nhập</a></span></li>
                                   <?php 
                               }
                               ?>
...
<footer id="footer"><!--Footer-->
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="single-widget">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="#">Số điện thoại: 083937224</a></li>
                            <li><a href="#">Email: admin@gmail.com</a></li>
                            <li><a href="#">Địa chỉ: 459 Tôn Đức Thắng - Liên Chiểu - Đà Nẵng</a></li>
                ...
                <div class="col-sm-4">
                    ...
                    <a href="https://www.google.com.vn/" target="_blank" class="fa fa-google-plus"></a>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © 2021 ADVANCED. All rights reserved.</p>
            </div>
        </div>
    </div>
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v10.0" nonce="t4YYF21m"></script>

          ...
          @foreach($admin as $key => $user)
            <form action="{{url('/assign-roles')}}" method="POST">
              ...
              <td>
                ...
                <a style="margin:5px 0 " class="btn btn-sm btn-danger" href="{{url('/delete-user-roles/'.$user->admin_id)}}">Delete user</a>
                <a style="margin:5px 0 " class="btn btn-sm btn-success" href="{{url('/impersonate/'.$user->admin_id)}}">Change role</a>
              </td> 
